...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_DELT,        CTL_T(KC_F1),         CTL_T(KC_F2), CTL_T(KC_F3),  CTL_T(KC_F4),   KC_Y,   TG(SYMB),
        KC_LALT,        LT(NUM,KC_A), LT(OPERATORS,KC_O),    LT(DOTS,KC_E), LT(DIRECTION, KC_U),   LT(ACTION,KC_I),
        KC_LSFT,        CTL_T(KC_Z), KC_Q,    KC_J,   KC_K,   KC_J, ALL_T(KC_NO),
        ...
        // right hand
	     ...
	     LT(SYMB, KC_K),  LT(STOPCON, KC_R), LT(SYMB, KC_S), LT(KC_RCTL,KC_F) , LT(SNIP,KC_N),KC_RSFT,
...
[ACTION] = KEYMAP(  // layer 0 : default
        ...
        // right hand
	     ...
	     TG(SYMB),    KC_KP_ASTERISK,  KC_INS, KC_UNDO,   KC_EXLM,   LSFT(KC_QUOT),             KC_BSLS,
                         KC_DEL, KC_ESC, ,    KC_ENTER, KC_TAB, KC_FN12 ,
